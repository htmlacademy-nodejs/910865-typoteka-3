...
const mockData = [
  ...
  },
  {
    ...
    "announce":"Самый лучший музыкальный альбом этого года Учим HTML и CSS Обзор новейшего смартфона",
  ...
  },
  {
    ...
    "announce":"Как перестать беспокоиться и начать жить Как достигнуть успеха не вставая с кресла Учим HTML и CSS Что такое золотое сечение",
